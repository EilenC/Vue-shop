<template>
    <div class="login_container">
        <div class="login_box">
            ...
            <!-- 表单区域 -->
            <el-form ref="loginFormRef" label-width="0" class="login_from" :model="loginForm" :rules="rules">
                <!-- 用户名 -->
                <el-form-item prop="username">
                    <el-input prefix-icon="iconfont icon-wode" v-model="loginForm.username"></el-input>
                </el-form-item>
